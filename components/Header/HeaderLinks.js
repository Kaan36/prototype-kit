    ...
    <List className={classes.list + " " + classes.mlAuto}>
      ...
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          buttonIcon={ViewDay}
          dropdownList={[
            <Link href='/sections#headers' legacyBehavior>
              <a
                className={classes.dropdownLink}
            ...
            <Link href='/sections#features' legacyBehavior>
              <a
                className={classes.dropdownLink}
            ...
            <Link href='/sections#blogs' legacyBehavior>
              <a
                className={classes.dropdownLink}
            ...
            <Link href='/sections#teams' legacyBehavior>
              <a
                className={classes.dropdownLink}
            ...
            <Link href='/sections#projects' legacyBehavior>
              <a
                className={classes.dropdownLink}
            ...
            <Link href='/sections#pricing' legacyBehavior>
              <a
                className={classes.dropdownLink}
            ...
            <Link href='/sections#testimonials' legacyBehavior>
              <a
                className={classes.dropdownLink}
            ...
            <Link href='/sections#contacts' legacyBehavior>
              <a
                className={classes.dropdownLink}
